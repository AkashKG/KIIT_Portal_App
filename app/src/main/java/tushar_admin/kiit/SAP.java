 ...
 */
public class SAP extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String ua = "Mozilla/5.0 (Linux; Android 4.1.1; HTC One X Build/JRO03C) " +
                "AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.58 Mobile Safari/537.31";
        wv.getSettings().setUseWideViewPort(true);
        wv.getSettings().setJavaScriptEnabled(true);
        // wv.getSettings().setLoadWithOverviewMode(true);
        wv.getSettings().setUserAgentString(ua);

        wv.loadUrl("http://kiitportal.kiituniversity.net/irj/portal");
    }
